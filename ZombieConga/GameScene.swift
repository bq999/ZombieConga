...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        livesLabel2.text = "Cats: X"
        livesLabel2.fontColor = SKColor.black
        livesLabel2.fontSize = 100
        livesLabel2.zPosition = 150
        livesLabel2.horizontalAlignmentMode = .right
        livesLabel2.verticalAlignmentMode = .bottom
        livesLabel2.position = CGPoint(
            x: playableRect.size.width/2 - CGFloat(20),
            y: -playableRect.size.height/2 + CGFloat(20))
        cameraNode.addChild(livesLabel2)
    ...
    func moveTrain() {
        ...
        livesLabel2.text = "Cat: \(trainCount)"
